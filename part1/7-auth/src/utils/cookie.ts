...
export const setCookie = (token: Token) => {
    ...
    document.cookie = `accessToken=${token.accessToken}; max-age=20; path=/`
...
// بمند از طریق اکسس توکن میشناسه
// اگه قرار باشه با هر بار درخواست اکسس تومن ست کنیم  توی هدر هارد کد میشه
...
export default (cookieName: string) => {
